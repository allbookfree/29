...
export const MODEL_REQUEST_INFO = {
  ...
  "or-auto":            { providerName: "OpenRouter", endpoint: "openrouter.ai/api/v1/chat/completions", modelId: "openrouter/free", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)", extra: "Official auto-router · Routes to best free model · Vision-capable · 200K context" },
  ...
  "or-qwen3":           { providerName: "OpenRouter", endpoint: "openrouter.ai/api/v1/chat/completions", modelId: "qwen/qwen3-next-80b-a3b-instruct:free", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)" },
  ...
  "or-hermes":          { providerName: "OpenRouter", endpoint: "openrouter.ai/api/v1/chat/completions", modelId: "nousresearch/hermes-3-llama-3.1-405b:free", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)" },
