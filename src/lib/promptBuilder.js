...
export const MODEL_REQUEST_INFO = {
  ...
  "or-gemma":           { providerName: "OpenRouter", endpoint: "openrouter.ai/api/v1/chat/completions", modelId: "google/gemma-3-27b-it:free", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)" },
  "or-stepfun":         { providerName: "OpenRouter", endpoint: "openrouter.ai/api/v1/chat/completions", modelId: "stepfun/step-3.5-flash:free", temperature: 0.9, maxTokens: 8192, requestFormat: "OpenAI-compatible (messages array)" },
